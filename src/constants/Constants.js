...
const GETJDSTATISTICS=`${ONLINEBASEURL}/api/operatorStatistics/getJDStatistics`
const GETOFFERCONFIGS=`${ONLINEBASEURL}/api/operatorOfferConfig/getOfferConfigs`
const CREATEOFFERCONFIG=`${ONLINEBASEURL}/api/operatorOfferConfig/createOfferConfig`
const UPDATEOFFERCONFIG=`${ONLINEBASEURL}/api/operatorOfferConfig/updateOfferConfig`
const GETOFFERCONFIG=`${ONLINEBASEURL}/api/OfferConfig/getOfferConfig`
const GETCOMPANYPRICE=`${ONLINEBASEURL}/api/operatorCompany/account`
const POSTCHONGCOMPANYPRICE=`${ONLINEBASEURL}/api/operatorCompany/rechargeAccount`
...
module.exports = {
    ...
    GETJDSTATISTICS:GETJDSTATISTICS,
    GETOFFERCONFIGS:GETOFFERCONFIGS,
    CREATEOFFERCONFIG:CREATEOFFERCONFIG,
    UPDATEOFFERCONFIG:UPDATEOFFERCONFIG,
    GETOFFERCONFIG:GETOFFERCONFIG,
    GETCOMPANYPRICE:GETCOMPANYPRICE,
    POSTCHONGCOMPANYPRICE:POSTCHONGCOMPANYPRICE
}
